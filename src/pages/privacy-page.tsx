...
import { LocalProcessingExplanation } from "@/components/privacy/local-processing-explanation";
...
export function PrivacyPage() {
  usePageMetadata({
    ...
    description:
      "Understand Paperlane's privacy approach for browser-local PDF tools, concept previews and transparent document workflows.",
  });
