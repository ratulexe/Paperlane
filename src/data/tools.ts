...
export const tools: DocumentTool[] = [
  {
    ...
    detailedDescription: "Preview how related PDF documents could be ordered and combined in a transparent workflow.",
    category: "organise",
    icon: FileStack,
    acceptedFileTypes: [pdfFileType],
    badges: ["popular"],
    workflowSteps: ["Select PDFs", "Arrange file order", "Simulate merge workflow"],
  ...
  },
  {
    ...
    detailedDescription: "Explore a page-separation workflow that explains extraction choices before any action begins.",
    category: "organise",
    icon: Scissors,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Choose split option", "Simulate split workflow"],
    availableInDemo: true,
    configKind: "split",
  },
  {
    ...
    detailedDescription: "Preview a simple orientation workflow for pages that need rotation before review.",
    category: "organise",
    icon: RotateCw,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Choose rotation", "Simulate rotation workflow"],
    availableInDemo: true,
    configKind: "rotate",
  },
  {
    ...
    detailedDescription: "Use generated page labels to explore how a future reorder workflow could be presented.",
    category: "organise",
    icon: ListOrdered,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Adjust example page order", "Simulate reorder workflow"],
    availableInDemo: true,
    configKind: "reorder",
  },
  {
  ...
  },
  {
    id: "jpg-to-pdf",
    name: "JPG to PDF",
    shortDescription: "Combine image files into a PDF-style document.",
    detailedDescription: "Preview how image files could be collected into a document-style workflow.",
    category: "convert",
    icon: Image,
    acceptedFileTypes: [imageFileType],
    badges: ["none"],
    workflowSteps: ["Select images", "Review PDF output", "Simulate conversion workflow"],
    availableInDemo: true,
    configKind: "output-format",
  },
  {
    id: "pdf-to-jpg",
    name: "PDF to JPG",
    shortDescription: "Present document pages as image previews.",
    detailedDescription: "Explore how PDF pages could be represented as image output choices in a clear interface.",
    category: "convert",
    icon: FileImage,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Choose image output", "Simulate conversion workflow"],
    availableInDemo: true,
    configKind: "output-format",
  },
  {
  ...
  },
  {
    ...
    shortDescription: "Review and remove unnecessary empty pages.",
    detailedDescription: "Explore a review-first workflow for possible blank-page removal.",
    category: "optimise",
    icon: Droplets,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Choose review setting", "Simulate cleanup workflow"],
    availableInDemo: true,
  ...
  },
  {
    id: "add-watermark",
    name: "Add Watermark",
    shortDescription: "Preview text or image watermark placement.",
    detailedDescription: "Explore watermark text and position choices in a controlled interface.",
    category: "security",
    icon: FilePenLine,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Choose watermark placement", "Simulate watermark workflow"],
    availableInDemo: true,
  ...
  },
  {
    id: "sign-document",
    name: "Sign Document",
    shortDescription: "Present a signature placement and review workflow.",
    detailedDescription: "Preview signer name and placement choices without capturing real signatures.",
    category: "security",
    icon: FileSearch,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Choose signature placement", "Simulate signing workflow"],
    availableInDemo: true,
    configKind: "sign",
  },
];
