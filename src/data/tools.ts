...
export const tools: DocumentTool[] = [
  ...
  },
  {
    id: "protect-pdf",
    name: "Protect PDF",
    shortDescription: "Add an open password using temporary cloud processing.",
    detailedDescription: "Protect one PDF with an open password through Paperlane's temporary cloud worker and explicit consent flow.",
    category: "security",
    icon: FileLock2,
    acceptedFileTypes: [pdfFileType],
    badges: ["none"],
    workflowSteps: ["Select a PDF", "Enter password", "Run temporary cloud protection"],
    availableInDemo: true,
    configKind: "protect",
    implementationStatus: "functional-cloud",
  },
